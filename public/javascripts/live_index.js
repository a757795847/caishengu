(function ($) {
    ...
    $.ajax({
        type:'GET',
        url:"http://" + backend_host + '/web/staff/caishengu/live/collection?'+token,
        dataType:'json',
    ...
    $('#trends').on('click','.delete',function(){
        ...
        $.ajax({
            type:'DELETE',
            url:"http://" + backend_host + '/web/staff/caishengu/live/entity?live_id='+trend_id+'&access_token=10ae0842b11080b0b6c9412773164797',
            dataType:'json',
            success:function(data){
                console.log(data);
                deleteThis.fadeOut();
